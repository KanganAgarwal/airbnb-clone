...
const Footer = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-4 gap-y-10 px-32 py-14 bg-gray-100 text-gray-600 '>
        ...
        <p className="font-semibold">Referrals accepted</p>
        <p className="font-semibold">Kangan</p>
        </div>
        <div className='space-y-4 text-sm text-gray-800'>
...
<p className="font-semibold">Zero to Full stack Hero</p>
<p className="font-semibold">Hundreds of Students</p>
